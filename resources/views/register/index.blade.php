      ...
      <div class="container">
        <div class="row g-0">
          ...
          <div class="col-lg-7 px-5 pt-5">
            ...
            <h4 class="fw-bold py-3" style="color: #1178B3">Buat Akun Baru</h4>
            <form action="/register" method="POST">
				@csrf
				<div class="form-row">
					<div class="col-lg-7">
					  <input type="text" name="name" placeholder="Nama Lengkap" class="form-control my-3 p-2 @error('name') is-invalid @enderror"   value="{{ old('name') }}">
					  @error('name')
				...
				<br>
              	<small>Sudah Punya Akun? <a href="/login" class="fw-bold" style="color: #9095A3;">Masuk</a></small>
